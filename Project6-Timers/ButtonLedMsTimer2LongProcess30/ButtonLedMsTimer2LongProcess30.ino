/*
  ...
  - Uses MsTimer2 to call a callback after 30 mseconds to turn LED off
...
const unsigned long ledDuration = 30UL; // 30 mseconds
const unsigned long debounceDelay = 3UL;
